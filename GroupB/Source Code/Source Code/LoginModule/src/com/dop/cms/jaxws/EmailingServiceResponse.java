...
@XmlRootElement(name = "emailingServiceResponse", namespace = "http://cms.dop.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "emailingServiceResponse", namespace = "http://cms.dop.com/")
public class EmailingServiceResponse {
